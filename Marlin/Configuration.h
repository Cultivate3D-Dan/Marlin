...
#define HOTEND_OFFSET_X { 0.0, -39.2 } // (mm) relative X-offset for each nozzle
...
#define MAX_BED_POWER 150 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 40.51
  #define DEFAULT_bedKi 2.48
  #define DEFAULT_bedKd 440.7
...
#define Z_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop. Change to False for 2 pin endstop.
#define X_MAX_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop.
#define Y_MAX_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop.
//#define Y2_MAX_ENDSTOP_INVERTING true 
#define Z_MAX_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop.
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // Set to true to invert the logic of the probe. Change to fales for 2 pin endstop. 
 ...
 * :[2,3,4,5,6,7]
 */
//#define ENDSTOP_NOISE_THRESHOLD 
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 240, 415,415}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 50, 60,60 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 7.0 }
...
#define X_BED_SIZE 920
#define Y_BED_SIZE 528
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (3200)
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS), (Y_MIN_POS), 10 }
...
#define SHARED_SERVO_PINS

// (ms) Delay  before the next move will start, to give the servo time to reach its target angle.
// 300ms is a good value but you can try less delay.
// If the servo can't reach the requested position, increase it.
#define SERVO_DELAY {50,50} //60
